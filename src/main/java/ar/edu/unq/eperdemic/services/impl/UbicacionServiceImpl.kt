...
//            var ubicacionOrigen=HibernateUbicacionDao.recuperar(vector.ubicacion?.nombreUbicacion!!)
            vector.ubicacion=HibernateUbicacionDao.recuperar(nombreUbicacion)//actualizo Ubicacion de Vector
